...
/**
 * Test cases for {@link PlugwiseHAHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Kaj Visser - Initial contribution
 */
public class PlugwiseHAHandlerTest extends JavaTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new PlugwiseHAHandler(thing);
